...
local function _RemoveTalent(id)
  if DBM_Disease.adv_protected then
    RemoveTalent(id)
  else
    secured = false
...
DBM_Disease.event.register("MACRO_ACTION_FORBIDDEN", hide_block)
DBM_Disease.event.register("ADDON_ACTION_FORBIDDEN", hide_block)
DBM_Disease.event.register("ADDON_ACTION_BLOCKED", hide_block)